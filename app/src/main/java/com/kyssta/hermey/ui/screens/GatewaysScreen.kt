...
import com.kyssta.hermey.auth.clearHostCookies
import com.kyssta.hermey.network.GatewayCookieJar
import com.kyssta.hermey.network.ServerProfile
import com.kyssta.hermey.network.parseProfiles
    ...
    fun switchServerProfile(name: String, onSwitched: () -> Unit) {
        ...
        scope.launch {
            try {
                ...
                switchError = com.kyssta.hermey.network.gatewayErrorMessage(e)
            }
        }
    }
